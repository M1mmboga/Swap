package com.example.swap.rest.addressconstants;
...
public class Addresses {
    ...
    private static final String MIZZY_HOME="192.168.100.52";

    public static final String BASE_URL = "http://" + MIZZY_HOME + "/swapapi";
